...
async def test_llm():
    ...
    try:
        ...
        print(f"GEMINI_API_KEY presente: {bool(settings.GEMINI_API_KEY)}")
        
        # Testar com o provider configurado
        print(f"\nCriando adapter com provider: {settings.LLM_PROVIDER}...")
        ...
        print(f"Resposta do LLM: {response[:100]}...")
